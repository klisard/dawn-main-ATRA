...
- **Product card frame** is forced to 3:4 with the whole photo visible (letterbox #f0eeea) (`atra.css`, `.card--standard .card__inner.ratio`); the section "Image ratio" setting no longer matters for product cards.
